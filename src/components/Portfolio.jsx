...
const projects = [
  ...
  },
  {
    ...
    description:
      "A dynamic, full-stack real estate platform for browsing and managing property listings. This MERN stack application features advanced search and filtering, user accounts for saving favorite properties, and an agent dashboard.",
  ...
  {
  img: "/ruwwaad1.jpg",
  sliderImages: ["/ruwwaad1.jpg", "/ruwwaad2.jpg", "/ruwwaad3.jpg", "/ruwwaad4.jpg", "/ruwwaad5.jpg", "/ruwwaad6.jpg", "/ruwwaad7.jpg", "/ruwwaad8.jpg", "/ruwwaad9.jpg", "/ruwwaad10.jpg", "/ruwwaad11.jpg"],
  title: "Ruwwaad Technologies Site",
  description:
    "A full-stack corporate website designed for Ruwwaad Technologies using the MERN stack. It features a dynamic and responsive UI built with React, a secure Node/Express backend for handling client inquiries, and a MongoDB database for content management. The platform includes an admin dashboard to easily update services, portfolio projects, and company news in real-time.",
                ...
                >
                  <div className="relative overflow-hidden rounded-2xl bg-[#003459] shadow-2xl border-2 border-[#003459] hover:border-[#00a8e8]/50 transition-all duration-300">
                    <img
                      src={project.img}
                      alt={project.title}
                      className="w-full h-[60vh] object-contain transition-transform duration-500 group-hover:scale-105"
                    />
